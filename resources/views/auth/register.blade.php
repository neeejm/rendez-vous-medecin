                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    ...
                                    <input id="male" type="radio" class="form-check-label" @error('gender') is-invalid @enderror" name="gender" value="1" required autocomplete="gender" autofocus>
                                </div>
                                <div class="form-check">
                                    <label for="female" class="form-check-input">{{ __('Femme') }}</label>
                                    <input id="female" type="radio" class="form-check-label" @error('gender') is-invalid @enderror" name="gender" value="0" required autocomplete="gender" autofocus>
                                </div>
